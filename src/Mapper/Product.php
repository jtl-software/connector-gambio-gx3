...
class Product extends BaseMapper
{
        ...
        if (count($return) < $limit) {
            ...
            foreach ($combis as $combiData) {
                ...
                foreach ($variationQuery as $variation) {
                    ...
                    $variations[$variation['properties_id']]['i18ns'][$variation['language_id']] = [
                        $variation['properties_name'],
                        $variation['values_name'],
                    ];
                }
    ...
    private function determineQuantityUnit($data)
    {
        ...
        if ($skip === false) {
            ...
            $this->db->deleteInsertRow($quantityProduct, 'products_quantity_unit', 'products_id',
                $quantityProduct->products_id);
        }
    }
