...
class ProductAttr extends BaseMapper
{
    ...
    public function pull($data = null, $limit = null)
    {
        ...
        if (!empty($data['google_export_condition'])) {
            $attrs[] = $this->createAttr('google_export_condition', 'Google Zustand', $data['google_export_condition'],
                $data);
        }
        
        if (!empty($data['google_export_availability_id'])) {
            $attrs[] = $this->createAttr('google_export_availability_id', 'Google Verfuegbarkeit ID',
                $data['google_export_availability_id'], $data);
        }
