        ...
        foreach ($data->getAttributes() as $attr) {
            foreach ($attr->getI18ns() as $i18n) {
                ...
                if ($specialAttribute) {
                    ...
                    $this->db->query('UPDATE products_description SET checkout_information="'.$this->db->escapeString($i18n->getValue()).'" WHERE products_id="' . $productsId . '" && language_id='.$language_id);
