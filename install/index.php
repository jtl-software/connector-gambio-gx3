...
<head>
    ...
    <title>JTL-Connector Konfiguration</title>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <span class="glyphicon glyphicon-transfer"></span> JTL-Connector Konfiguration<span
                            class="pull-right label label-info">v<?php echo CONNECTOR_VERSION; ?></span>
                </h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="post">
                    <?php echo $installer->runAndGetData(); ?>
                </form>
            </div>
        </div>
        <?php
